				...
				for (int j = 0; j <= loopDuration; j++)
				{
					...
					if(abs(pCam0.x - currentSubImgPos.x) < 0.5 && abs(pCam0.y - currentSubImgPos.y) < 0.5) {
						...
						if(outputCam0Value.w > realCamera0Colors.w){
								...
								outputCam0Value = tex2D(_Cam0, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) - (currentSubImgPos.x - pCam0.x))) / subImageWidth, (((i.pos.y % subImageWidth) / subImageWidth))));

								//texture look-up in the depth without linear interpolation
								outputCam0Value.w = tex2D(_Cam0, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) )) / subImageWidth, (((i.pos.y % subImageWidth ) / subImageWidth)))).w;
						}
					}
					...
					if(abs(pCam1.x - currentSubImgPos.x) < 0.5 && abs(pCam1.y - currentSubImgPos.y) < 0.5) {
						if(outputCam1Value.w > realCamera1Colors.w){
								...
								outputCam1Value = tex2D(_Cam1, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) - abs(currentSubImgPos.x - pCam1.x))) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth))));

								outputCam1Value.w = tex2D(_Cam1, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) )) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth)))).w;
						}
					}
					...
					if(abs(pCam2.x - currentSubImgPos.x) < 0.5 && abs(pCam2.y - currentSubImgPos.y) < 0.5) {
						if(outputCam1Value.w > realCamera2Colors.w){
								...
								outputCam2Value = tex2D(_Cam2, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) - abs(currentSubImgPos.x - pCam2.x))) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth))));

								outputCam2Value.w = tex2D(_Cam2, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) )) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth)))).w;
						}
					}
					...
					if(abs(pCam3.x - currentSubImgPos.x) < 0.5 && abs(pCam3.y - currentSubImgPos.y) < 0.5) {
						if(outputCam3Value.w > realCamera3Colors.w){
								...
								outputCam3Value = tex2D(_Cam3, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) - abs(currentSubImgPos.x - pCam3.x))) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth))));

								outputCam3Value.w = tex2D(_Cam3, float2((((i.pos.x % subImageWidth + (j - (loopDuration / 2.0))) )) / subImageWidth, (((i.pos.y % (1.0/_Cam0_TexelSize.x)) / subImageWidth)))).w;
						}
					}
				}
